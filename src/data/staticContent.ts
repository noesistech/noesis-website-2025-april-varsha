...
export const aboutSectionData: AboutSection = {
  ...
  description_2: 'With 175+ years of combined experience, we've pioneered the integration of human expertise and AI capabilities, establishing ourselves as leaders in AI-enhanced digital technology services.',
...
export const missionSectionData: MissionSection = {
  ...
  vision_title: 'Vision',
  vision_description: 'To lead the AI revolution in digital solutions, pioneering the perfect balance of artificial intelligence and human creativity for the world's most innovative organizations.',
