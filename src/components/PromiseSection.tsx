    ...
    <section className="py-16 sm:py-24">
      <div className="container mx-auto px-6 relative z-10">
        ...
        <div className="max-w-3xl mx-auto mt-16">
          <div 
            ref={promiseCardRef} 
            className="bg-[#1d2130]/80 backdrop-blur-sm rounded-xl p-8 md:p-10 transition-transform duration-300 ease-out shadow-xl border border-white/5 hover:border-white/10 py-[35px]"
          >
