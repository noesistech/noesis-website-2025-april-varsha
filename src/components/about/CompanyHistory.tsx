      ...
      <div className="container mx-auto px-4 md:px-6 py-0">
        <div className="max-w-4xl mx-auto text-center space-y-8 py-[40px]">
          ...
          <div className="mt-16 relative pt-8">
            ...
            <div className="absolute left-[20%] md:left-1/2 transform -translate-x-[1px] h-full w-[2px] bg-gradient-to-b from-noesis-purple/80 to-noesis-blue/40 px-0 mx-[10px]"></div>
...
const TimelineItem = ({
  ...
  return <div ref={ref} className="relative">
      {/* Mobile layout - year and dot on left side, all content on right */}
      <div className="md:hidden grid grid-cols-[2fr_5fr] gap-2">
        {/* Year and dot on the left */}
        <motion.div className="relative flex items-center" initial={{
          ...
          <h3 className="text-lg font-semibold text-noesis-purple mr-2">
            {year}
          </h3>
          {/* Timeline dot positioned next to year */}
          <motion.div className="absolute right-1 z-10" initial={{
            scale: 0
          }} animate={isInView ? {
            scale: 1
          } : {
            ...
            <div className={`w-4 h-4 ${dotColor} rounded-full border-2 border-white shadow-lg shadow-${dotColor}/30`}></div>
          </motion.div>
        </motion.div>
      ...
      <div className="hidden md:block">
        ...
        <div className="grid grid-cols-2 gap-8">
          {/* Left content */}
          <motion.div className="text-right pr-12" initial={{
            x: -50,
            opacity: 0
          }} animate={isInView ? {
            x: 0,
          ...
          {/* Right content */}
          <motion.div className="pl-12" initial={{
            x: 50,
            opacity: 0
          }} animate={isInView ? {
            x: 0,
