      ...
      <div className="container mx-auto px-4 md:px-6 py-0">
        <div className="max-w-4xl mx-auto text-center space-y-8 py-[40px]">
          ...
          <div className="mt-16 relative pt-8">
            ...
            <div className="absolute left-[20%] md:left-1/2 transform -translate-x-[1px] h-full w-[2px] bg-gradient-to-b from-noesis-purple/80 to-noesis-blue/40 px-0 mx-[13px]"></div>
