...
const MissionCard = ({
  ...
  return <div className="relative flex flex-col items-center my-[10px]">
      ...
      {/* Card content */}
      <div id="mission-card" className="glass-card animate-fade-in relative transition-transform duration-500 ease-out transform p-8 md:p-10 mt-10 pt-12 md:pt-14 w-full my-[20px]">
        <h3 className="text-2xl md:text-3xl lg:text-4xl font-bold gradient-text mb-4 md:mb-8 pt-4 md:pt-6 relative text-center my-0">
          {title}
        ...
        <p className="text-standard mt-4 md:mt-8 text-center py-0 my-[30px]">
          {description}
        </p>
      </div>
    </div>;
