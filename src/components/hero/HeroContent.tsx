    ...
    <div className="animate-fade-in">
      ...
      <div className="flex flex-col sm:flex-row gap-4">
        <a href="#contact" className="inline-block">
          <Button className="text-white text-md sm:text-lg py-5 md:py-6 px-6 md:px-8 w-full" variant="noesis">
            Get in Touch
          </Button>
        </a>
        <a href="#services" className="inline-block">
          <Button variant="outline" className="border-white/20 text-white hover:bg-white/10 text-md sm:text-lg py-5 md:py-6 px-6 md:px-8 w-full">
            Our Services
          </Button>
        </a>
      </div>
