  ...
  return <Card className="bg-[#1E2335] border-[#2A304B] overflow-hidden">
      <CardContent className="p-0">
        <div className="p-6 flex flex-col h-full">
          {/* Product Logo */}
          {product.logoUrl && <div className="mb-6 max-w-[250px]">
              <img src={product.logoUrl} alt={`${product.title} logo`} onError={handleImageError} className="w-full h-auto object-fill" />
            </div>}
