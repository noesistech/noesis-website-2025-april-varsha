...
const FounderSection = () => {
  ...
  return <div className="container mx-auto px-4 mb-12 sm:mb-20">
      <div className="flex flex-col lg:flex-row gap-6 sm:gap-8 items-center">
        ...
        <div className="lg:w-2/3">
          <Card className="bg-gradient-to-b from-gray-800/40 to-gray-900/40 backdrop-blur-sm border border-gray-700/50 p-4 sm:p-6">
            <div className="space-y-4 sm:space-y-6">
              <div className="flex items-start gap-3 sm:gap-4">
                <Building className="w-5 h-5 sm:w-6 sm:h-6 text-noesis-purple flex-shrink-0 mt-1" />
                <div>
                  <h4 className="text-base sm:text-lg font-semibold mb-1 sm:mb-2 text-white">Founder & CEO</h4>
              ...
              <div className="flex items-start gap-3 sm:gap-4">
                <GraduationCap className="w-5 h-5 sm:w-6 sm:h-6 text-noesis-purple flex-shrink-0 mt-1" />
                <div>
                  <h4 className="text-base sm:text-lg font-semibold mb-1 sm:mb-2 text-white">Education & Expertise</h4>
                  <p className="text-white/80 text-sm sm:text-base leading-relaxed">
              ...
              <div className="flex items-start gap-3 sm:gap-4">
                <Briefcase className="w-5 h-5 sm:w-6 sm:h-6 text-noesis-purple flex-shrink-0 mt-1" />
                <div>
                  <h4 className="text-base sm:text-lg font-semibold mb-1 sm:mb-2 text-white">Vision & Innovation</h4>
                  <p className="text-white/80 text-sm sm:text-base leading-relaxed">
