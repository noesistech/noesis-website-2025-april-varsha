...
const ServicesSection: React.FC<ServicesProps> = ({
  ...
  const displayServices = services && services.length > 0 ? services.map(service => ({
    ...
    id: 'ui-ux',
    icon: <PenTool className="h-10 w-10 text-noesis-purple" />,
    title: 'UI/UX',
...
const getIconByName = (iconName: string) => {
  ...
  switch (normalizedIconName) {
    ...
    case 'globe':
      return <Globe className="h-10 w-10 text-noesis-blue" />;
    case 'laptop':
    case 'computer':
      return <Laptop className="h-10 w-10 text-purple-400" />;
    case 'code':
      return <Code className="h-10 w-10 text-purple-400" />;
    case 'cloud':
      return <Cloud className="h-10 w-10 text-pink-400" />;
    case 'database':
      return <Database className="h-10 w-10 text-pink-400" />;
    case 'brain':
    case 'brain-circuit':
    case 'braincircuit':
      return <BrainCircuit className="h-10 w-10 text-green-400" />;
    case 'users':
      return <Users className="h-10 w-10 text-yellow-400" />;
    case 'pen-tool':
    case 'pentool':
      return <PenTool className="h-10 w-10 text-noesis-purple" />;
    case 'trending-up':
    case 'trendingup':
      return <TrendingUp className="h-10 w-10 text-blue-400" />;
    case 'image':
      return <Image className="h-10 w-10 text-purple-400" />;
    default:
