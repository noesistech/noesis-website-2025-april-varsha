        ...
        <Tabs defaultValue="tech" className="max-w-5xl mx-auto">
          <div className="flex justify-center mb-6 sm:mb-8">
            <TabsList className="glass">
              <TabsTrigger 
                value="tech" 
                className="data-[state=active]:bg-noesis-purple data-[state=active]:text-white px-4 sm:px-6"
              ...
              <TabsTrigger 
                value="cloud"
                className="data-[state=active]:bg-noesis-blue data-[state=active]:text-white px-4 sm:px-6"
