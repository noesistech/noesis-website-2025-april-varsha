        ...
        <div className="flex flex-col md:flex-row gap-10">
          ...
          <div className="md:w-1/2 animate-fade-in">
            <div className="bg-[#1A1F2C] border border-purple-500/20 p-1 rounded-lg h-full">
              <div className={`w-full ${isMobile || isTablet ? 'max-h-[40vh]' : 'h-full min-h-[400px]'} rounded relative overflow-hidden`}>
                <P5Animation />
              </div>
            </div>
          </div>
          ...
          animationDelay: '0.2s'
            ...
            <h2 className="text-2xl sm:text-3xl md:text-4xl lg:text-5xl font-bold mb-8 relative">
            ...
            {/* Stats Grid - responsive for different screen sizes */}
            <div className="grid grid-cols-2 gap-3 sm:gap-4 md:gap-6 mt-8 sm:mt-10">
              {/* Stat 1 */}
              <div className="bg-[#242836] p-4 sm:p-6 rounded-lg flex flex-col items-center justify-center animate-fade-in" style={{
              animationDelay: '0.3s'
            }}>
                <div className="bg-purple-900/30 p-2 sm:p-3 rounded-full mb-2 sm:mb-4">
                  <Users className="w-5 h-5 sm:w-6 sm:h-6 text-purple-400" />
                </div>
                <h3 className="text-xl sm:text-2xl md:text-3xl lg:text-4xl font-bold text-purple-300">40</h3>
              ...
              animationDelay: '0.4s'
                ...
                <h3 className="text-xl sm:text-2xl md:text-3xl lg:text-4xl font-bold text-purple-300">15+</h3>
              ...
              animationDelay: '0.5s'
                ...
                <h3 className="text-xl sm:text-2xl md:text-3xl lg:text-4xl font-bold text-purple-300 text-center">&gt; 4 Years</h3>
              ...
              animationDelay: '0.6s'
                ...
                <div className="bg-purple-900/30 p-2 sm:p-3 rounded-full mb-2 sm:mb-4">
                  <Percent className="w-5 h-5 sm:w-6 sm:h-6 text-purple-400" />
                </div>
                <h3 className="text-xl sm:text-2xl md:text-3xl lg:text-4xl font-bold text-purple-300">95%</h3>
