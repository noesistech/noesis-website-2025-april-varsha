  ...
  "inline-flex items-center justify-center gap-2 whitespace-nowrap rounded-md text-sm font-medium ring-offset-background transition-colors focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2 disabled:pointer-events-none disabled:opacity-50 [&_svg]:pointer-events-none [&_svg]:size-4 [&_svg]:shrink-0",
  {
    variants: {
      variant: {
        ...
        rainbow: "bg-noesis-purple/30 text-white relative overflow-hidden transition-all duration-300 hover:shadow-[0_0_15px_rgba(160,116,255,0.5)] hover:bg-noesis-purple/40 hover:scale-105 after:absolute after:inset-0 after:content-[''] after:bg-gradient-to-r after:from-transparent after:via-white/20 after:to-transparent after:translate-x-[-100%] after:hover:animate-shine border-2 border-transparent [border-image:linear-gradient(to_right,#a074ff,#8257e6,#4ea7ff,#2fcbcf,#4ade80,#f6e05e,#f472b6,#d946ef,#a074ff)_1] animate-border-rainbow",
      },
      size: {
