...
const TeamSection: React.FC<TeamSectionProps> = ({ title, subtitle, teamMembers }) => {
  ...
  return (
    <section className="page-section flex justify-center w-full pt-0">
                    ...
                    <>
                      ...
                      <img
                        ...
                        className={`w-full h-full object-cover ${
                          member.id === 'team-3' ? 'object-top -mt-8' : 'object-center'
                        } transition-transform duration-500 group-hover:scale-105 relative z-[1] ${
