...
const Footer = () => {
  ...
  return (
    <footer className="bg-gradient-to-b from-noesis-darker to-black py-12 mt-20 border-t border-white/10">
      <div className="container mx-auto">
        <div className="grid grid-cols-1 md:grid-cols-12 lg:grid-cols-12 gap-8 lg:gap-12">
          ...
          <div className="md:col-span-12 lg:col-span-3 order-1">
            <div className="flex flex-col md:flex-row lg:flex-col gap-6 md:items-start">
              ...
              <div className="flex-1">
                <p className="text-white/70 mb-6 max-w-none md:max-w-[400px] lg:max-w-[280px]">
          ...
          {/* Contact Us */}
          <div className="md:col-span-12 lg:col-span-6 order-3">
